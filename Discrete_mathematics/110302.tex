\begin{lemma} $\alpha(G) \le (m+2)C_m^p$,
    ...
    \begin{proof}
        ...
        %$$F_x(y) = \sum c y_{i_1}^{\alpha_{i_1}} \cdots y_{i_q}^{\alpha_{i_q}}$$
        %$\forall j y_j \in \{0, 1\} \Rightarrow \tilde{F_{\bar{x}}(\bar{y}) = \sum{c \cdots y_{i_1} \cdots y_{i_q}} }$
